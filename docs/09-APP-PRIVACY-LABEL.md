...
- Public policy/support site: Sites version 5 is public at `https://weekkeep-app.kimsol1134.chatgpt.site`; site tests passed 8 with 0 failures, and logged-out `/`, `/privacy`, `/support`, and `/terms` returned HTTP 200.
